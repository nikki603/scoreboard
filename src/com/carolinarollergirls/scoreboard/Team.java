...
public interface Team extends ScoreBoardEventProvider
{
	...
	public static interface AlternateName extends ScoreBoardEventProvider {
		...
		public static final String ID_JERSEY = "jersey";
	...
	public static interface Color extends ScoreBoardEventProvider {
		...
		public static final String ID_JERSEY_FG = "jersey_fg";
		public static final String ID_JERSEY_BG = "jersey_bg";
		public static final String ID_OVERLAY_FG = "overlay_fg";
		public static final String ID_OVERLAY_BG = "overlay_bg";
	}
}
